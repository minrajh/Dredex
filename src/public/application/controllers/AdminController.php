...
class AdminController extends Controller {
	...
	public function addAction() {
		if (!empty($_POST)) {
			...
			$this->view->message('success', 'Проект добавлен');
		}
		$this->view->render('Добавить проект', 'ключевое слово', 'Описание');
	}
	...
	public function chartsAction() {
		$this->view->render('Графики | Панель управления', 'ключевое слово', 'Описание');
	}	

	public function mainAction() {
		$this->view->render('Панель управления', 'ключевое слово', 'Описание');
	}

	public function servicesAction() {
		$this->view->render('Добавить услугу', 'ключевое слово', 'Описание');
	}
}